...
*Data from the dates 2007-02-01 to
2007-02-02 is used. 
...
* Each plot is constructed and saved as a PNG file with a width of 480
pixels and a height of 480 pixels.

* Each of the plot files is named as `plot1.png`, `plot2.png`, etc.

* Separate R code file (`plot1.R`, `plot2.R`, etc.)
constructs the corresponding plot, i.e. code in `plot1.R` constructs
the `plot1.png` plot. The codes include code for reading
the dataso that the plot can be fully reproduced.
